...
export function RevalidatingBanner({ source }: { source: string }) {
  return (
    <div className="rounded-md bg-blue-50 border border-blue-200 px-3 py-2 text-xs text-blue-700 dark:bg-blue-950/30 dark:border-blue-800 dark:text-blue-400">
